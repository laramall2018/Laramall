...
<link rel="stylesheet" href="{{url('front/matrix/sweetalert/sweetalert.css')}}" type="text/css" />
...
<script src="{{url('front/matrix/sweetalert/sweetalert.min.js')}}" type="text/javascript"></script>
