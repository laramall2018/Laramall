<div class="row">
	<div class="col s12">
		<div class="card-panel">
			{!!Form::open(['url'=>'mobile/address/'.$model->id,'method'=>'post','files'=>'true'])!!}
					...
					<select name="province" id="province" class="pcd-select" data-tag="city">
						...
						@foreach(App\Models\Region::province() as $province)
							<option value="{!!$province->region_id!!}" 
									@if($province->region_id == $model->province) 
									selected="selected"  
									@endif>
				...
				<div class="row">
        		<div class="input-field col s12">
          			<input id="consignee" name="consignee" type="text" value="{!!$model->consignee!!}" class="validate">
				...
				<div class="row">
        		<div class="input-field col s12">
          			<input id="email" name="email" type="text" value="{!!$model->email!!}" class="validate">
				...
				<div class="row">
        		<div class="input-field col s12">
          			<input id="phone" name="phone" type="text" value="{!!$model->phone!!}" class="validate">
				...
				<div class="row">
        		<div class="input-field col s12">
          			<input id="address" name="address" type="text" value="{!!$model->address!!}" class="validate">
				...
				<div class="input-field col s12">
					...
					<span class="btn address-del-btn blue" data-id="{!!$model->id!!}">
						{!!trans('front.delete')!!}
					</span>
