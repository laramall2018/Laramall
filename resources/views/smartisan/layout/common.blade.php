...
<link rel="stylesheet" type="text/css" href="{!!url('front/smartisan/tingle/tingle.min.css')!!}"/>
...
<script src="{{url('front/smartisan/tingle/tingle.min.js')}}" type="text/javascript"></script>
<script type="text/javascript" src="{!!url('front/smartisan/js/larastore.js')!!}"></script>
<script type="text/javascript" src="{!!url('front/smartisan/js/form.js')!!}"></script>
</head>
<body>
	
	@include('smartisan.lib.top')
    @yield('content')
    @include('smartisan.lib.footer')
