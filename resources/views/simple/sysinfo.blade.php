...
<head>
    ...
    <link rel="stylesheet" href="{!!url('404/css/style.css')!!}">
</head>
<body>
    <!-- Page Loader    -->
      <div class="spinner">
    ...
    <nav class="navigation">
        <ul>
            <li><a href="{!!url(env('ADMIN_LOGIN_URL'))!!}">重新登录</a></li>
            <li><a href="{!!url('/')!!}">网站首页</a></li>
            <li><a href="http://www.prorigine.com" target="_blank">联系我们</a></li>
        </ul>
    </nav>
  ...
  <div id="svg_container">      
    ...
    <script src="{!!url('404/js/lib/jquery.min.js')!!}"></script>  
    <script src="{!!url('404/js/code.js')!!}"></script>
