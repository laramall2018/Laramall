        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
               ...
               <div class="ps-tab">
                   ...
                   {!!Form::open(['url'=>'admin/goods','method'=>'post','files'=>true,'class'=>'form-horizontal'])!!}
                    ...
                    <div class="ps-tab-content">
                        ...
                        @include('simple.goods.lib.base')
                        @include('simple.goods.lib.ueditor')
                        @include('simple.goods.lib.gallery')
                        @include('simple.goods.lib.other')
                        @include('simple.goods.lib.attr')
                        @include('simple.goods.lib.field')
                        @include('simple.goods.lib.goods')
                        @include('simple.goods.lib.article')
                    </div>
