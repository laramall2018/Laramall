...
class AlipayNotify {
	...
	function getSignVeryfy($para_temp, $sign) {
		...
		switch (strtoupper(trim($this->alipay_config['sign_type']))) {
			case "RSA" :
				$isSgin = $this->common->rsaVerify($prestr, trim($this->alipay_config['ali_public_key_path']), $sign);
				break;
			default :
				$isSgin = false;
		}
	...
	function getResponse($notify_id) {
		...
		$responseTxt = $this->common->getHttpResponseGET($veryfy_url, $this->alipay_config['cacert']);
