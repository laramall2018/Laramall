<?php namespace Phpstore\Shipping;
...
class CommonHelper{
    ...
    */  
    function __construct(){
        ...
        $this->add_url              = 'admin/shipping/add';
        $this->update_url           = 'admin/shipping/update';
        $this->del_url              = 'admin/shipping/delete/';
    ...
    */
    public function setTableDataCol(TableData $tableData){
        ...
        $tableData->addCol('shipping_name','shipping_name','配送名称','');
        $tableData->addCol('shipping_code','shipping_code','配送代码','');
        $tableData->addCol('fee','fee','配送费','');
        $tableData->addCol('shipping_desc','shipping_desc','配送描述','');
        $tableData->addCol('tag','tag_str','支付接口状态','');
        $tableData->addCol('insure','insure','担保费用','');
        $tableData->addCol('free_total','free_total','满额减运费','');
