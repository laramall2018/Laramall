...
class CommonHelper{
	...
	*/  
	function __construct(){
        ...
        $this->add_url              = 'admin/catad/add';
        $this->update_url           = 'admin/catad/update';
        $this->del_url              = 'admin/catad/delete/';
    ...
    */
    public function setTableDataCol(TableData $tableData){
        ...
        $tableData->addCol('cat_id','cat_name','分类名称','100px');
    ...
    public function EditData($model){
        ...
        return [
                    ...
                    [
                        ...
                        'selected_name' => ($model->category)? $model->category->cat_name:'',
