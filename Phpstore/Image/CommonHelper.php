...
class CommonHelper{
	...
	*/  
	function __construct(){
        ...
        $this->add_url              = 'admin/image/add';
        $this->update_url           = 'admin/image/update';
        $this->del_url              = 'admin/image/delete/';
    ...
    */
    public function setTableDataCol(TableData $tableData){
        ...
        $tableData->addCol('position','position','图片位置','');
        $tableData->addCol('img_tag','img_tag','图片标签','');
        $tableData->addCol('img_site','img_site_name','所属站点','');
    ...
    */
    public function getData($data){
        ...
        foreach($data as $key=>$value){
            ...
            $model                                  = Image::find($value['id']);
            $data[$key]['img_src_str']              = Common::image($model->icon());
            $data[$key]['img_site_name']            = Common::get_site_name($value['img_site']);
    ...
    public function FormData(){
        ...
        return [
                    ...
                    [
                        ...
                        'field'         => 'img_site',
                        'name'          => '所属站点',
                        'option_list'   => Common::get_site_option_list(),
                        'selected_name' => '请选择图片所属站点',
                        'selected_value'=> 0,
                        'id'            => 'img_site',
                    ],
    ...
    public function EditData($model){
        ...
        return [
                    ...
                    [
                        ...
                        'name'          => '所属站点',
                        'option_list'   => Common::get_site_option_list(),
                        'selected_name' => Common::get_site_name($model->img_site),
                        'selected_value'=> $model->img_site,
                        'id'            => 'img_site',
                    ],
