<?php namespace Phpstore\Supplier;
...
class CommonHelper{
    ...
    */
    public function setTableDataCol(TableData $tableData){
        ...
        $tableData->addCol('username','username','用户名称','200px');
        $tableData->addCol('email','email','电子邮件','');
        $tableData->addCol('phone','phone','手机号码','');
        $tableData->addCol('ip','ip','注册ip地址','');
        $tableData->addCol('reg_from','reg_from','注册来源','');
        $tableData->addCol('add_time','add_time_str','注册时间','');
        $tableData->addCol('tag','tag_str','状态','');
    ...
    public function FormData(){
        ...
        return [
                    ...
                    [
                        ...
                        'field'         => 'tag',
                        'name'          => '审核状态',
                        'radio_row'     => $this->get_radio_show_list(),
                        'checked'       => 1,
                        'id'            => 'tag',
                    ],
                    [
    ...
    */
    ...
    |-------------------------------------------------------------------------------
    */
    public function get_radio_show_list(){
