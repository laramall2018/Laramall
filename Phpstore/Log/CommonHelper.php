...
class CommonHelper{
    ...
    */
    public function setTableDataCol(TableData $tableData){
        ...
        $tableData->addCol('log_info','log_info','日志内容','');
        $tableData->addCol('user_id','username','操作管理员','');
        $tableData->addCol('add_time','add_time_str','操作时间','');
    ...
    */
    public function getData($data){
        ...
        foreach($data as $key=>$value){
            ...
            $data[$key]['username']                 = Common::get_user_name($value['user_id']);
