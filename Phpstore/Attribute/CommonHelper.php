<?php namespace Phpstore\Attribute;
...
class CommonHelper{
    ...
    */
    public function setTableDataCol(TableData $tableData){
        ...
        $tableData->addCol('attr_name','attr_name','属性名称','200px');
        $tableData->addCol('attr_type','attr_type_str','属性类型','');
				$tableData->addCol('type_id','goods_type','商品类型','');
        $tableData->addCol('sort_order','sort_order','排序','');
        $tableData->addCol('img_tag','img_tag_str','图片控件','');
        $tableData->addCol('color_tag','color_tag_str','颜色控件','');
    ...
    */
    public function getData($data){
        ...
        foreach($data as $key=>$value){
            ...
            $data[$key]['color_tag_str']            = Common::get_tag_status($value['color_tag']);
            $data[$key]['img_tag_str']              = Common::get_tag_status($value['img_tag']);
            $data[$key]['attr_type_str']            = Common::get_type_name($value['attr_type'],'attr_type');
						$data[$key]['goods_type']            	  = Common::get_goods_type($value['type_id']);
    ...
    public function FormData(){
        ...
        return [
                    ...
                    [
                        ...
                        'field'         => 'attr_type',
                        'name'          => '属性类型',
                        'radio_row'     => Common::get_radio_attr_list(),
                        'checked'       => 0,
                        'id'            => 'attr_type',
                    ],
