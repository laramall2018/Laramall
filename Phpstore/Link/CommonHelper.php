...
class CommonHelper{
	...
	*/
	function __construct(){
		...
		//定义商品的常用操作链接
        $this->list_url             = 'admin/link';
        $this->add_url              = 'admin/link/create';
        $this->update_url           = 'admin/link/update';
        $this->edit_url             = 'admin/link/edit/';
        $this->del_url              = 'admin/link/delete/';
        $this->ajax_url             = 'admin/link/grid';
        $this->batch_url            = 'admin/link/batch';
	}
    ...
    */
    public function tableDataInit(){
        ...
        //设置参数
        $tableData->put('table','friend_link');
    ...
    */
    public function setTableDataCol(TableData $tableData){
        ...
        $tableData->addCol('link_name','link_name','链接名称','200px');
        $tableData->addCol('link_url','link_url','链接url','');
        $tableData->addCol('link_site','link_site_str','链接城市','');
    ...
    */
    public function getData($data){
        ...
        foreach($data as $key=>$value){
            ...
            $data[$key]['link_site_str']            = $this->get_city_name($value['link_site']);
            //操作链接
            $data[$key]['edit_url']                 = Common::get_resource_edit_url('admin/link',$value['id']);
        ...
        return [
                    ...
                    //下拉选择表单
                     [
                        ...
                        'option_list'   => $this->get_select_option_list(),
                        'selected_name' =>'请选择分站点',
                        'selected_value'=> $model->link_site ,
                        'id'            => 'link_site',
                    ],
    ...
    */
    public function get_select_option_list(){
         ...
         $row          = DB::table('city_site')->get();
         $str           = '';

         foreach($row as $item){

             $str .='<option value="'.$item->site_code.'">'.$item->site_name.'</option>';
         }
    ...
    */
    ...
    |-----------------------------------------------------------------------
    */
    public function get_city_name($site_code){


        $row        = DB::table('city_site')->where('site_code',$site_code)->first();
