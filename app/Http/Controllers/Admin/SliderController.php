...
use Phpstore\Slider\CommonHelper;
use Request;
use Validator;
...
class SliderController extends BaseController{
    ...
    */   
    ...
    function __construct(){
        ...
        $this->add_url              = 'admin/slider/create';
        $this->update_url           = 'admin/slider/update';
        $this->del_url              = 'admin/slider/del/';
    ...
    */
    public function index(){
        ...
        $view->page                 = $this->page;
        $view->tag                  = $this->tag;
        $current_url                = HTML::link($this->list_url,trans('admin.slider_list'));
        $view->path_url             = $this->get_path_url($current_url);
        $view->action_name          = trans('admin.slider_list');

        //生成添加按钮
        $view->add_btn              = Common::get_add_btn($this->add_url,trans('admin.add_slider'));
        ...
        //$grid->portlet()
        $grid->put('color','blue');
        $grid->put('action_name',trans('admin.slider_list'));
        $view->grid                 = $grid;
    ...
    */
    public function edit($id){
        ...
        $view                       = $this->view('crud_add');
        $view->action_name          = trans('admin.edit_slider');
        $view->page                 = $this->page;
        $view->tag                  = $this->tag;
        $current_url                = HTML::link($this->edit_url.$id,trans('admin.edit_slider'));
        $view->path_url             = $this->get_path_url($current_url);
