...
use Phpstore\Shipping\CommonHelper;
use Request;
use Validator;
...
class ShippingController extends BaseController{
    ...
    */   
    ...
    function __construct(){
    	...
    	parent::__construct();
        $this->page                 = 'config';
        $this->tag                  = 'admin.shipping.index';
        $this->crud                 = new Crud();
        $this->form_to_model        = new FormToModel();

        //定义商品的常用操作链接
        $this->list_url             = 'admin/shipping';
        $this->edit_url             = 'admin/shipping/edit';
        $this->add_url              = 'admin/shipping/create';
        $this->update_url           = 'admin/shipping/update';
        $this->del_url              = 'admin/shipping/del/';
        $this->batch_url            = 'admin/shipping/batch';
        $this->preview_url          = '';
        $this->ajax_url             = 'admin/shipping/grid';
    ...
    */
    public function index(){
        ...
        $view->page                 = $this->page;
        $view->tag                  = $this->tag;
        $current_url                = HTML::link($this->list_url,trans('admin.shipping_list'));
        $view->path_url             = $this->get_path_url($current_url);
        $view->action_name          = trans('admin.shipping_list');

        //生成添加按钮
        $view->add_btn              = Common::get_add_btn($this->add_url,trans('admin.add_shipping'));
        ...
        //$grid->portlet()
        $grid->put('color','blue');
        $grid->put('action_name',trans('admin.shipping_list'));
        $view->grid                 = $grid;
    ...
    */
    public function create(){
        ...
        $view->page         = $this->page;
        $view->tag          = 'admin.shipping.index';
        $current_url        = HTML::link($this->add_url,trans('admin.add_shipping'));
        $view->path_url     = $this->get_path_url($current_url);

        $view->action_name  = trans('admin.add_shipping');
    ...
    */
    public function edit($id){
        ...
        $view                       = $this->view('crud_add');
        $view->action_name          = trans('admin.edit_shipping');
        $view->page                 = $this->page;
        $view->tag                  = $this->tag;
        $current_url                = HTML::link($this->edit_url.$id,trans('admin.edit_shipping'));
        $view->path_url             = $this->get_path_url($current_url);
