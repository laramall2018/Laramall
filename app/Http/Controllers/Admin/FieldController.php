...
use Phpstore\Field\CommonHelper;
...
class FieldController extends BaseController{
    ...
    */
    public function index(){
        ...
        $view->page                 = $this->page;
        $view->tag                  = $this->tag;
        $current_url                = HTML::link($this->list_url,Lang::get('field_list'));
        $view->path_url             = $this->get_path_url($current_url);
        $view->action_name          = Lang::get('field_list');


        //生成添加按钮
        $view->add_btn              = Common::get_add_btn($this->add_url,Lang::get('add_field'));
        ...
        //$grid->portlet()
        $grid->put('color','blue');
        $grid->put('action_name',Lang::get('field_list'));
        $view->grid                 = $grid;
    ...
    */
    public function create(){
        ...
        $view->page         = $this->page;
        $view->tag          = 'admin.field.index';
        $current_url        = HTML::link($this->add_url,Lang::get('add_field'));
        $view->path_url     = $this->get_path_url($current_url);

        $view->action_name  = Lang::get('add_field');
    ...
    */
    public function edit($id){
        ...
        $view                       = $this->view('crud_add');
        $view->action_name          = Lang::get('edit_field');
        $view->page                 = $this->page;
        $view->tag                  = $this->tag;
        $current_url                = HTML::link($this->list_url.'/'.$id,Lang::get('edit_field'));
        $view->path_url             = $this->get_path_url($current_url);
