...
use Phpstore\Link\CommonHelper;
use Request;
use Validator;
...
class LinkController extends BaseController{
    ...
    */
    public function index(){
        ...
        $view->page                 = $this->page;
        $view->tag                  = $this->tag;
        $current_url                = HTML::link($this->list_url,trans('admin.link_list'));
        $view->path_url             = $this->get_path_url($current_url);
        $view->action_name          = trans('admin.link_list');

        //生成添加按钮
        $view->add_btn              = Common::get_add_btn($this->add_url,trans('admin.add_link'));
        ...
        //$grid->portlet()
        $grid->put('color','blue');
        $grid->put('action_name',trans('admin.link_list'));
        $view->grid                 = $grid;
    ...
    */
    public function create(){
        ...
        $view->page         = $this->page;
        $view->tag          = $this->tag;
        $current_url        = HTML::link($this->add_url,trans('admin.add_link'));
        $view->path_url     = $this->get_path_url($current_url);

        $view->action_name  = trans('admin.add_link');
