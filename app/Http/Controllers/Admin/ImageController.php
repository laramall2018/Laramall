...
use Phpstore\Image\CommonHelper;
use Request;
use Validator;
...
class ImageController extends BaseController{
    ...
    */   
    ...
    function __construct(){
    	...
    	parent::__construct();
        $this->page                 = 'common';
        $this->tag                  = 'admin.image.index';
        $this->crud                 = new Crud();
        $this->form_to_model        = new FormToModel();

        //定义商品的常用操作链接
        $this->list_url             = 'admin/image';
        $this->edit_url             = 'admin/image/edit';
        $this->add_url              = 'admin/image/create';
        $this->update_url           = 'admin/image/update';
        $this->del_url              = 'admin/image/del/';
        $this->batch_url            = 'admin/image/batch';
        $this->preview_url          = '';
        $this->ajax_url             = 'admin/image/grid';
    ...
    */
    public function index(){
        ...
        $view->page                 = $this->page;
        $view->tag                  = $this->tag;
        $current_url                = HTML::link($this->list_url,Lang::get('image_list'));
        $view->path_url             = $this->get_path_url($current_url);
        $view->action_name          = Lang::get('image_list');

        //生成添加按钮
        $view->add_btn              = Common::get_add_btn($this->add_url,Lang::get('add_image'));
    ...
    */
    public function create(){
        ...
        $view->page         = $this->page;
        $view->tag          = 'admin.image.index';
        $current_url        = HTML::link($this->add_url,Lang::get('add_image'));
        $view->path_url     = $this->get_path_url($current_url);

        $view->action_name  = Lang::get('add_image');
    ...
    */
    public function store(){
         ...
         $rules         = [
                                ...
                                'img_name'=>'required',
                                'img_tag' =>'required|unique:image,img_tag',
                                'img_src' =>'required'
    ...
    */
    public function edit($id){
        ...
        $view                       = $this->view('crud_add');
        $view->action_name          = Lang::get('edit_image');
        $view->page                 = $this->page;
        $view->tag                  = $this->tag;
        $current_url                = HTML::link($this->edit_url.$id,Lang::get('edit_image'));
        $view->path_url             = $this->get_path_url($current_url);
    ...
    */
    public function update(){
        ...
        $rules          = [
                                'img_name'=>'required',
                                'img_tag' =>'required|unique:image,img_tag,'.$id,
