...
use Phpstore\Payment\CommonHelper;
use Request;
use Validator;
...
class PaymentController extends BaseController{
    ...
    */   
    ...
    function __construct(){
        ...
        $this->add_url              = 'admin/payment/create';
        $this->update_url           = 'admin/payment/update';
        $this->del_url              = 'admin/payment/del/';
    ...
    */
    public function index(){
        ...
        $view->page                 = $this->page;
        $view->tag                  = $this->tag;
        $current_url                = HTML::link($this->list_url,trans('admin.payment_list'));
        $view->path_url             = $this->get_path_url($current_url);
        $view->action_name          = trans('admin.payment_list');

        //生成添加按钮
        $view->add_btn              = Common::get_add_btn($this->add_url,trans('admin.add_payment'));
        ...
        //$grid->portlet()
        $grid->put('color','blue');
        $grid->put('action_name',trans('admin.payment_list'));
        $view->grid                 = $grid;
    ...
    */
    public function create(){
        ...
        $view->page         = $this->page;
        $view->tag          = 'admin.payment.index';
        $current_url        = HTML::link($this->add_url,trans('admin.add_payment'));
        $view->path_url     = $this->get_path_url($current_url);

        $view->action_name  = trans('admin.add_payment');
    ...
    */
    public function edit($id){
        ...
        $view                       = $this->view('crud_add');
        $view->action_name          = trans('admin.edit_payment');
        $view->page                 = $this->page;
        $view->tag                  = $this->tag;
        $current_url                = HTML::link($this->edit_url.$id,trans('admin.edit_payment'));
        $view->path_url             = $this->get_path_url($current_url);
